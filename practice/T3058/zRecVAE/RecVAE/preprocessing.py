...
parser.add_argument('--dataset', type=str, default= "/opt/ml/ratings.csv")
parser.add_argument('--output_dir', type=str, default="/opt/ml/output")
parser.add_argument('--threshold', type=float, default=0)
parser.add_argument('--min_items_per_user', type=int, default=0)
parser.add_argument('--min_users_per_item', type=int, default=0)
parser.add_argument('--heldout_users', type=int, default=6000)
...
test_data_tr = numerize(train_plays)
