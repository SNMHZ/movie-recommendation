...
class MovieLens1M(DatasetLoader):
    def __init__(self, data_dir):
        self.fpath = os.path.join(data_dir, 'train_ratings.csv')
...
def main(args):
    ...
    elif args.dataset == 'train_ratings':
        df = MovieLens1M(args.data_dir).load()
    else:
        raise NotImplementedError
...
if __name__ == '__main__':
    ...
    parser.add_argument('--dataset',
                        default="train_ratings",
                        choices=['ml-1m', 'ml-20m', 'amazon-beauty', 'gowalla'])
    parser.add_argument('--data_dir',
                        type=str,
                        default=os.path.join('/opt/ml/zBPR2/bpr/data/', 'ml-1m'),
                        help="File path for raw data")
    parser.add_argument('--output_data',
                        type=str,
                        default=os.path.join('/opt/ml/zBPR2/bpr/preprocessed/', 'ml-1m.pickle'),
